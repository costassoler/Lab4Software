...
Parameters:
StartL: The lowest galactic longitude value you plan to observe

EndL: The highest galactic longitude value you plan to observe


StartB: The lowest galactic latitude value you plan to observe

EndB: The highest galactic latitude value you plan to observe

Returns:

Arrays containing the Ra and Dec values corresponding to each galactic pointing within your specified start and end coordinates. This assumes a longitude spacing of 4 degrees, and a latitude spacing of 2 degrees.
...
PointsL: An array of galactic desired longitude coordinates

PointsB: An array of galactic desired latitudes


Returns:
First - blocks of the original l and b values, but they are brokemn up into blocks that each correspond to a constellation in which they fall.

Second - Names of the corresponding constellations for each new data block. Look them up to ballpark rise and set times and reserve telescope time!
...
def mapper(l,b,LO,MapName):
    '''
    Parameters:
    l: any array of galactic longitudes
    b: any array of corresponding galactic latitudes
    LO: your desired L.O.'s frequency
    MapName: Your desired file name.
    
    Returns:
    A file containing a header and spectra for each pointing (l and b location). The file will be named
    "MapNamel_b.FITS", where l and b are the galactic longitude and latitude at which that file's data
    was collected
    '''
